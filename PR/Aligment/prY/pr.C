...
void pr(){
	...
	//==================================================//
	//=============== Set x and y Angle ================//
	double xAngleDownSet=79.9;//" 89.4。"
	double yAngle0=0.;//"。"
	double xAngleUpSet=80.1;
...
//	cout <<"Y angle tan:"<<TMath::Tan(yAngle)<<endl;
	...
	continue;}	
		...
		if(TanAlpha>TMath::Tan(xAngleDown)&&TanAlpha<TMath::Tan(xAngleUp)&&TanGamma>TMath::Tan(yAngle)){
			//	cout <<endl;	
			//	cout <<px1<<" "<<py1<<"  "<<px2<<" "<<py2<<" "<<px3<<" "<<py3<<" "<<x_residual<<" Event:  "<< i<<endl;
			//	cout <<x_residual<<"  Entry:"<<i<<"  XAngle:"<<TanAlpha<<" YAngle: "<<TanGamma<<endl;
